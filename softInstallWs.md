...
!!! Читайте комментарии в самом конце скрипта!!!
...
# Для её установки переходим по ссылке с инструкцией: https://sevo44.ru/lxc-ustanovka-na-centos-7/ 
# и находим пункт Установка LXC 3.0 на CentOS 7 и следуюем инструкции на сайте. После установки 3-ей 
# версии lxc проблем с запуском воркспейса не возникнет
```
