...
Параметр позволяет включить/выключить проверки при запуске команды up дистрибутива. Если параметр не задействован, проверки будут пройзведены в зависимости от значения по умолчанию.

`checks.avx` - `boolean` если включен, будет произведена проверка [AVX инструкций](https://www.ikmultimedia.com/faq/?id=1254). Значение по умолчанию - true
