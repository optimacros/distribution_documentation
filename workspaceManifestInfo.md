...
Параметр позволяет включить/выключить проверки при запуске команды up дистрибутива.

`checks.avx` - `boolean` если включен, будет произведена проверка [AVX инструкций](https://www.ikmultimedia.com/faq/?id=1254)
