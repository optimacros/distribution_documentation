...
При определенной настройке ALT Server 9.1 (зависит от галочек при установке ОС) на порту 8080 можем находится веб панель управления серверов, 
данный порт в случае не https установке использоваться для вебсокета воркспейса и может быть конфликт портов.
