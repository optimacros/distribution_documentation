...
Дожидаемся окончания такого вывода терминала:
...
(по адресу http://.../admin/config/urls) для правильных ссылок в отправляемых емейлах о сбросе пароля и приглашении 
новых пользователей.
